...
import egems from '../images/currency/egembundlesm.png';
...
export default function Account() {
  ...
  return (
    <div>
      ...
      <h3>Account Info :</h3>
      <h5>Gems:{userstate.gems}</h5><img height='32' src={gems}/>
      <h5>Elite Gems:{userstate.Egems}</h5><img height='32' src={egems}/>
      <h1>Owned Cards</h1>
