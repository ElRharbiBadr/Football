...
export default function Game() {
  ...
  return (
    ...
    <div id='ready'>
      ...
      <div>
      <img
        src={picked['GK'] === '' ? silverimg :(picked['GK'].image)}
        alt=""
        width="250"
      />
      </div>
      ...
      <select id='LB' onChange={(e)=>{addPlater(e.target.value,e.target.id,e)}}><option value='' default>Pick Player...</option>{cardsnondupe.map((card)=>{
            ...
            <div>
      <img
        src={picked['LB'] === '' ? silverimg :(picked['LB'].image)}
        alt=""
        width="250"
      />
      </div>
      ...
      <h4>LCB</h4>
            ...
            <div>
      <img
        src={picked['LCB'] === '' ? silverimg : (picked['LCB'].image)}
        alt=""
        width="250"
      />
      </div>
      ...
      <h4>RCB</h4>
            ...
            <div>
      <img
        src={picked['RCB'] === '' ? silverimg : (picked['RCB'].image)}
        alt=""
        width="250"
      />
      </div>
      ...
      <h4>RB</h4>
            ...
            <div>
      <img
        src={picked['RB'] === '' ? silverimg : (picked['RB'].image)}
        alt=""
        width="250"
      />
      </div>
      ...
      <select id='LDM' onChange={(e)=>{addPlater(e.target.value,e.target.id,e)}}><option value='' default>Pick Player...</option>{cardsnondupe.map((card)=>{
            ...
            <div>
      <img
        src={picked['LDM'] === '' ? silverimg : (picked['LDM'].image)}
        alt=""
        width="250"
      />
      </div>
      ...
      <h4>RDM</h4>
            ...
            <div>
      <img
        src={picked['RDM'] === '' ? silverimg : (picked['RDM'].image)}
        alt=""
        width="250"
      />
      </div>
      ...
      <select id='LM' onChange={(e)=>{addPlater(e.target.value,e.target.id,e)}}><option value='' default>Pick Player...</option>{cardsnondupe.map((card)=>{
            ...
            <div>
      <img
        src={picked['LM'] === '' ? silverimg : (picked['LM'].image)}
        alt=""
        width="250"
      />
      </div>
      ...
      <h4>CM</h4>
            ...
            <div>
      <img
        src={picked['CM'] === '' ? silverimg : (picked['CM'].image)}
        alt=""
        width="250"
      />
      </div>
      ...
      <h4>RM</h4>
            ...
            <div>
      <img
        src={picked['RM'] === '' ? silverimg : (picked['RM'].image)}
        alt=""
        width="250"
      />
      </div>
      ...
      <select id='CAM' onChange={(e)=>{addPlater(e.target.value,e.target.id,e)}}><option value='' default>Pick Player...</option>{cardsnondupe.map((card)=>{
            ...
            <div>
      <img
        src={picked['CAM'] === '' ? silverimg : (picked['CAM'].image)}
        alt=""
        width="250"
      />
      </div>
