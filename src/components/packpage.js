...
import gems from '../images/currency/gembundlesm.png'
        ...
        return (
           <div>
            <div id='packshop'  style={{display : "inline"}}>
              ...
              <button class="button-64 text-center mx-auto m-4" role="button" id='buybutton' onClick={clickcheck}><span class="text">Open pack {pack.price}<img height='32' src={gems}/></span></button>
            <Row id='shop'>
                {packplayers.map((pl)=>{
        ...
        return (
          <div>          
            <div id='packshop' style={{display : "inline"}}>
             <h1>{pack.name}</h1>
             <h3>Featured Cards</h3>
             <button class="button-64 text-center mx-auto m-4" role="button" onClick={clickcheck}><span class="text">Open pack {pack.price}<img height='32' src={gems}/></span></button>
            <Row id='shop'>
